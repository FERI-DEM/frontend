...
export default function CommunityMemberJoin({ openModal, setOpenModal, powerPlants }: Props) {
    ...
    const onSubmit = async (event: any) => {
        ...
        if (
            ...
            await CommunityService.joinCommunity({
                ...
                .then(() => {
                    toast.success('Wuhooo! Uspešno ste oddali zahtevo za pridružitev skupnosti.');
                })
                .catch(() => {
                    toast.error('Ooops! Prišlo je do napake pri oddaji zahteve za pridružitev skupnosti.');
                })
    ...
    return (
        <>
            ...
            >
                <Modal.Header>Pridruži se skupnosti</Modal.Header>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                {powerPlants?.map((powerPlant, index) => {
                                    return (
                                        <div key={`CommunityMemberJoinCheckbox${index}`}>
                                            <input
                                                type="checkbox"
                                                id={`CommunityMemberJoin${index}`}
                                            ...
                                            />
                                            <label
                                                htmlFor={`CommunityMemberJoin${index}`}
